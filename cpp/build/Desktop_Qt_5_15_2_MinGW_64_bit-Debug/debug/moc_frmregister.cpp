...
QT_MOC_LITERAL(1, 12, 10), // "registered"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "loginSuccessful"
QT_MOC_LITERAL(4, 40, 23), // "onRegisterButtonClicked"
QT_MOC_LITERAL(5, 64, 14) // "onLoginClicked"

    },
    "FrmRegister\0registered\0\0loginSuccessful\0"
    "onRegisterButtonClicked\0onLoginClicked"
};
...
void FrmRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FrmRegister::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrmRegister::registered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FrmRegister::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrmRegister::loginSuccessful)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FrmRegister::registered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FrmRegister::loginSuccessful()
{
